...
const CustomerMenu = () => {
  ...
  const renderWelcomeStage = () => (
    <div className="relative min-h-screen w-full overflow-y-auto bg-[#FFFBF7] flex flex-col items-center justify-center px-4 py-16 select-none" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
      ...
      <div className={`relative z-10 w-full max-w-sm rounded-[2rem] bg-white/90 backdrop-blur-md border border-white/80 shadow-[0_20px_50px_rgba(255,122,0,0.12)] px-6 pt-12 pb-5 transition-all duration-700 ease-out ${
        ...
        <div className="mt-4 rounded-xl bg-white shadow-sm border border-orange-50 py-3.5 px-4 text-center">
          <p className="text-orange-500 font-bold tracking-wide text-[9.5px] mb-1">{t.tableLabel}</p>
          ...
          <div className="mt-2.5 inline-flex items-center gap-1.5 rounded-full bg-green-50 px-3.5 py-1 border border-green-100 shadow-sm text-green-700">
            ...
            <span className="font-bold text-[9px] uppercase tracking-wider">{t.scanSuccess}</span>
          </div>
        </div>
        ...
        <div className="mt-4 flex items-center justify-center gap-3.5 select-none">
          ...
          <span className="text-orange-400 font-bold text-xs mb-3">»</span>
          <div className="flex flex-col items-center gap-0.5">
        ...
        <button onClick={() => setStage('menu')} className="mt-4 w-full flex items-center justify-between rounded-full bg-gradient-to-r from-orange-500 to-orange-400 px-5 py-2.5 text-white font-extrabold text-[11px] shadow-md shadow-orange-200 active:scale-[0.98] transition-transform cursor-pointer uppercase tracking-wider">
        ...
        <div className="mt-3.5 flex items-center justify-center gap-2.5">
          {Object.keys(LANGS).map((code) => (
            <button key={code} onClick={() => setLang(code)} className={`rounded-full px-4 py-2 text-[10px] font-extrabold border transition-all cursor-pointer select-none ${
              lang === code
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl overflow-hidden bg-amber-500/10 flex items-center justify-center">
              <img src={chefImage} alt="Resto QR" className="w-full h-full object-cover" />
            </div>
            <div>
